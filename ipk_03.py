...
class Shape:
    ...
    def draw(self, canves): raise NotImplementedError
...
tk.Radiobutton(frame, text="사각형", value="rect", variable=var).pack(side="left", padx=6)
tk.Radiobutton(frame, text="원", value="circle", variable=var).pack(side="left", padx=6)
