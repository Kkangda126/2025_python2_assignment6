...
cb1 = tk.Checkbutton(frame, text="Python", variable=var_py)
cb2 = tk.Checkbutton(frame, text="AI", variable=var_ai)
cb3 = tk.Checkbutton(frame, text="DataScience", variable=var_ds)
...
botton_frame.pack(pady=6)

tk.Button(botton_frame, text="등록하기", command=register_courses).pack(side="left", padx=8)
tk.Button(botton_frame, text="초기화",   command=reset_all).pack(side="left", padx=8)
